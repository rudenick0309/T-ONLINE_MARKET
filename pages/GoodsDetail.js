      ...
      <Contents>
        ...
        <DetailInfoOfBottom>
          ...
          <ViewDetailInfoOfBottom>
            <ButtonDetailInfoOfBottom title={"info"} onPress={() => {
              setQna(false);
              setInfo(true);
              setReview(false);
            }}/>
            <ButtonDetailInfoOfBottom title={"qna"} onPress={() => {
              setQna(true);
              setInfo(false);
              setReview(false);
            }}/>
            <ButtonDetailInfoOfBottom title={"review"} onPress={() => {
              setQna(false);
              setInfo(false);
              setReview(true);
            }}/>
              ...
              (
                <View>
                  ...
                  {/*  TODO: Should this function(write a text) is a page? or component?*/}
                    ...
                    <QnAButtonDetailInfoOfBottom title={'+'} onPress={()=> {props.navigation.navigate("QnAPlus" )}}/>
              ...
              : review
                ...
                (
                  <ReviewDetailInfoOfBottom>
                    ...
                    <Button title={'+'} onPress={()=> {props.navigation.navigate("ReviewPlus" )}}></Button>
                    {/*  TODO: Should this function(write a text) is a page? or component?*/}
                  </ReviewDetailInfoOfBottom>
                )
